...
const Home = ({ setToken, setUser, setIsLoggedIn, setCartItems }) => {
	...
	return (
		<>
			<h1 className="welcome">Welcome to Catco</h1>
			...
			<p>
			<center>We hope you enjoy!</center>
			</p>
			<p>
			...
			<p>
			<center>
				<button onClick={handleClick} className="sign-in-button">Demo Customer Sign-In</button>
				<button onClick={handleAdminClick} className="admin-button">Demo Admin Sign-In</button>
			</center>
			</p>
		</>
	);
